...
$(document).ready(function() {
    ...
    Cufon.replace('#nav li a, #user_nav a, .nav2 a, .nav3 a, .newsletter a.subscribe, .newsletter a.subscribe_no, #myModal .nav a', {hover: true}); // Requires a selector engine for IE 6-7, see above
