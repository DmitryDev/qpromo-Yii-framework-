                    ...
                    <form id="signup-form" class="form-horizontal" action="" method="">
                        ...
                        <div class="control-group newsletter">
                            ...
                            <div class="controls">
                                ...
                                <a href="javascript:void(0)" class="subscribe active">Subscribe</a><a href="javascript:void(0)" class="subscribe_no">No, Thank you.</a>
                            </div>
                        </div>
                        <div class="control-group buttons">
                            <div class="controls">
...
<script type="text/javascript">
    $.get("js/product-page.js", function(data) {
        try {
...
<!-- Privacy page only scripts -->
<script src="js/jquery.easing.1.3.js"></script>
<script src="js/privacy-page.js"></script>
<!-- End Privacy page only -->
