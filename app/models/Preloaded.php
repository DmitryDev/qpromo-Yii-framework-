...
/**
 * This is the model class for table "preloaded".
 *
 * The followings are the available columns in table 'preloaded':
 * @property integer $id
 * @property string $name
 * @property string $description
 * @property string $image
 */
class Preloaded extends CActiveRecord
{
    ...
    public function uploadImage()
    {
        ...
        if ($this->imageUploader) {
            if (in_array($this->imageUploader->type, array('image/jpeg', 'image/pjpeg', 'image/png', 'image/x-png', 'image/gif'))) {
                ...
                $imagePath = $_SERVER['DOCUMENT_ROOT'] . Yii::app()->params['preloadedImagePath'];                
