...
<?php $form=$this->beginWidget('CActiveForm', array(
    ...
    <div class="row" style="margin-top: 15px;">        
        <?php echo CHtml::checkBox('Preloaded[deleteImage]'); ?><span>Delete Image</span>
        <div><?php echo CHtml::image(Yii::app()->params['preloadedImagePath'].'/'.$model->image); ?></div>        
    </div>
    <?php endif;?>

    <div class="row">
        <?php echo CHtml::label('Upload a new image', '', array('style'=>'font-weight: bold;')); ?>        
        <?php echo CHtml::fileField('Preloaded[image]', '', array('id'=>'image'));?>               
